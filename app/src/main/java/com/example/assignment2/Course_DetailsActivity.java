...
public class Course_DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseDetailsText = findViewById(R.id.course_details);
        courseImage=findViewById(R.id.course_image);
        courseDetailsText.setMovementMethod(new ScrollingMovementMethod());
    ...
    private void displayContent(){
        if("value1".equals(value)){
            courseImage.setImageResource(R.drawable.android_img);
            courseDetailsText.setText("content Android  >>>>> \n" +
                    "Part 1 ( Java SE) \n" +
            ...
            courseImage.setImageResource(R.drawable.full_stack_img);
            courseDetailsText.setText("Content Full Stack >>>>>\n" +
                    "•HTML\t\n" +
                    "•HTML 5 \n" +
                    "•CSS\n" +
                    "•CSS3\n" +
            ...
            courseImage.setImageResource(R.drawable.ios_img);
            courseDetailsText.setText("Content IOS  >>>>>\n" +
                    "\n" +
                    "OOP refreshment\n" +
                    "• Introduction\n" +
